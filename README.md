...
- [AJAX without Turbolinks](https://github.com/andrerferrer/respond-to-ajax-demo#goal) - How to implement AJAX in Rails without Turbolinks.
...
- [AJAX with JS.ERB](https://github.com/andrerferrer/rails-js-erb-demo#goal) - How to implement AJAX using `Javascript` and a `js.erb` view, which updates the DOM element.
